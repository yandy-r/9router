...
[`CLAUDE.md`](../CLAUDE.md), which are the
...
language-specific build/test commands (JavaScript/TypeScript), read
[`CLAUDE.md`](../CLAUDE.md) and [`CLAUDE.md`](../CLAUDE.md) before writing
code.
