...
describe("quota auto-ping", () => {
  ...
  beforeEach(async () => {
    ...
    ({ runQuotaAutoPingTick, configureQuotaAutoPing } = await import(
  ...
  it("does not ping same Codex reset twice when seconds drift", async () => {
        ...
        ? [
            {
              ...
              authType: "oauth",
              accessToken: "token",
              lastPingedResetAt: "2026-01-01T11:59:44.000Z",
            },
          ]
        : [],
    );
    ...
    getCodexUsage.mockResolvedValue({
      quotas: {
        session: { used: 0, total: 100, remaining: 100, resetAt: "2026-01-01T11:59:47.000Z" },
      },
    });
