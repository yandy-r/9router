    ...
    input: [
      {
        type: "message",
        role: "user",
        content: [{ type: "input_text", text: "Reply with the single word: hi" }],
      },
    ],
  }),
  multimodal: () => ({
  ...
  tools: () => ({
    ...
    input: [
      ...
      { type: "function_call_output", call_id: "call_1", output: '{"temp":"20C"}' },
      {
        type: "message",
        role: "user",
        content: [{ type: "input_text", text: "Summarize in one short sentence." }],
      },
    ],
  }),
  reasoning: () => ({
    ...
    input: [
      {
        type: "message",
        role: "user",
        content: [{ type: "input_text", text: "What is 17 + 26? Just the number." }],
      },
    ],
  }),
};
...
const claudeBody = {
  ...
  tools: () => ({
    ...
    messages: [
      ...
      {
        role: "user",
        content: [{ type: "tool_result", tool_use_id: "toolu_1", content: '{"temp":"20C"}' }],
      },
      { role: "user", content: "Summarize in one short sentence." },
    ],
  }),
      ...
      for (const scn of SCENARIOS) {
        it.concurrent(
          ...
          async () => {
            ...
            if (out === "skip") {
              console.warn(`[skip] ${providerId} ${fmt}/${scn}: cred/quota/capability`);
              return expect(true).toBe(true);
            }
